...
var loadMoodForm = function() {
    ...
    introSection.removeChild(document.querySelector("#intro-content"));
    ...
    introSection.appendChild(moodTitle);
    ...
    //Append form to page
    introSection.appendChild(moodForm);
    ...
    introSection.appendChild(cardsDiv);
    introSection.appendChild(sidebarDiv);
    ...
    introSection.querySelector("#moodForm").addEventListener("submit", function(event) {
        event.preventDefault();
